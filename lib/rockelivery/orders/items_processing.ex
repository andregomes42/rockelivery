defmodule Rockelivery.Orders.ItemsProcessing do
  def data_processing(items, items_ids, items_params) do
  ...
  defp multiply_items(true, _items, _items_params), do: {:error, "Invalid id!"}
